				...
				<table>
					<tr>
						...
						<td><input type="text" readonly="readonly" id="id" name="id"
							value="${produto.id}" placeholder="Preenchimento automático"></td>
					</tr>
					<tr>
						<td>Nome:</td>
						<td><input type="text" id="nome" name="nome" maxlength="100"
							style="width: 400px;" value="${produto.nome}"
							placeholder="Nome do produto/item"></td>
					</tr>

					<tr>
						<td>Quantidade Un.:</td>
						<td><input type="text" id="quantidade" name="quantidade"
							value="${produto.quantidade}" placeholder="Qtd/Un" maxlength="7"></td>
					</tr>
					<tr>
						<td>Valor R$:</td>
						<td><input type="text" id="valor" name="valor"
							data-thousands="." data-decimal="," data-precision="2"
							value="${produto.valorEmTexto}" placeholder="R$" maxlength="8"></td>
					<tr>
						<td></td>
						<td><input type="submit" value="Salvar" style="width: 90px">
							<input style="width: 90px" type="submit" value="Cancelar"
